...
output "cloudfront_distribution_trusted_signers" {
  ...
  value       = module.cdn.cloudfront_distribution_trusted_signers
}
...
output "cloudfront_distribution_last_modified_time" {
  ...
  value       = module.cdn.cloudfront_distribution_last_modified_time
}

output "cloudfront_distribution_in_progress_validation_batches" {
  description = "The number of invalidation batches currently in progress."
  value       = module.cdn.cloudfront_distribution_in_progress_validation_batches
}
...
output "cloudfront_origin_access_identities" {
  ...
  value       = module.cdn.cloudfront_origin_access_identities
}
